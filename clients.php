...
<table class="table table-striped table bordered">
    ...
    <?php
        if(mysqli_num_rows($result)>0){
            while($row=mysqli_fetch_assoc($result)){
                ...
                echo '<td><a href="edit.php?id=' . $row['id'] . '" type="button" class="btn btn-primary btn-sm">Edit</a></td>';
                echo "</tr>";
            }
        }else{
    ...
    ?>
    <tr>
        <td colspan="7"><div class="text-center"><a href="add.php" type="button" class="btn btn-sm btn-success">Add Client</a></div></td>
    </tr>
</table>