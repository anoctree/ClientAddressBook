...
if(isset($_POST['delete'])){
    $alertMessage =  "<div class='alert alert-danger'><P>Are you sure?</p><br><form action='". htmlspecialchars($_SERVER["PHP_SELF"]) . "?id=$clientID' method='post'><input type='submit' class='btn btn-danger btn-sm' name='confirm-delete' value='Yes, delete!'><button class='btn btn-primary btn-sm' data-dismiss='alert'>Oops, no thanks!</button></form></div>";
